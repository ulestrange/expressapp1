...
if (req.session.pageViews){
  ...
  req.session.shoppingcart = [
    {itemName :"milk", quantity : 3}, {itemName: "books", quantity : 4}]
}
else{
  ...
  'items': req.session.shoppingcart})
}
...
exports.postAddCar = (req, res) => {
  ...
  if (req.body.carname.includes('una')){
    ...
    req.session.carAdded = {"model": req.body.model,
...
exports.carAdded = (req, res) => 
res.render('carAdded', {car : req.session.carAdded});
